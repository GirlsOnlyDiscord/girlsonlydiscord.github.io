...
const FEATURES = [
  ...
  { emoji: "🌍", title: "Truly International", titleColor: "var(--brand-gold)",  text: "Members active across every time zone — there's always someone to study with." },
  { emoji: "💛", title: "Girls Only, Always",  titleColor: "var(--brand-green)", text: "Every member is verified. A safe, focused, girls-only environment." },
];
...
{FEATURES.map((f) => (
<div className="aboutFeatureCard" key={f.title} style={{ background: f.titleColor }}>
